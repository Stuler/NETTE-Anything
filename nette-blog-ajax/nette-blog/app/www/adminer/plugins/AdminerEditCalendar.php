...
class AdminerEditCalendar {
	 ...
	 */
	function __construct($prepend = null, $langPath = "js/jquery-ui/i18n/jquery.ui.datepicker-%s.js") {
		if ($prepend === null) {
			$prepend = "<link rel='stylesheet' type='text/css' href='js/jquery-ui/jquery-ui.css'>\n"
				. script_src("js/jquery.js")
				. script_src("js/jquery-ui/jquery-ui.js")
				. script_src("js/timepicker/jquery-ui-timepicker-addon.js")
				. script_src("js/timepicker/i18n/jquery-ui-timepicker-cs.js");
		}
